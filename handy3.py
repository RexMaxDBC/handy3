...
# --- CSS (KOMPLETT ÜBERARBEITET FÜR SCHÖNE BUTTONS) ---
st.markdown(f"""
<style>
    .stApp {{
...
if st.session_state.tasks:
    ...
    for t_name, t_data in list(st.session_state.tasks.items()):
        ...
        # Wir nutzen kleine Spalten mit "gap", um die Buttons zu trennen
        btn_col1, btn_col2, btn_spacer = st.columns([0.25, 0.25, 0.5])
        ...
        with btn_col2:
            # "Löschen" ist immer in der zweiten Spalte
